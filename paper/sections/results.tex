...
approximates. On the canonical draw M4, read from the observer
slice of Fig.~\ref{fig:hyb-ringdown-xq2}, recovers $\omega$ to
$0.139\%$ and $\tau$ to $2.90\%$ (Fig.~\ref{fig:hyb-plateau-m4};
the M5 scan is shown in Appendix~\ref{app:supp},
...
medians against that reference: the hybrid tracks it across all
five estimators, recovering $\omega$ to $0.323\%$ and $\tau$ to
$2.08\%$ on the primary M4 plateau against the reference's own
$0.246\%$ and $2.09\%$ --- an unbiased reproduction of the
reference spectroscopy at a fraction of the solve cost. We
benchmark the QNM against the fine reference, not the coarse
prior, because the prior is the surrogate's \emph{input}: its
role is the field baseline of Sec.~\ref{sec:res-hyb} (the
$82\times$ error reduction), and a coarse solve's own plateau
extraction reflects the estimator's stability under window
shifts rather than field quality, so it is not a meaningful
...
hybrid reproduces the reference extraction on every estimator;
its demonstrated gain over the coarse prior is in the
global field (Sec.~\ref{sec:res-hyb}), not the single-observer
QNM. Bold entries are
...
\midrule
M1 (FFT $+$ log-line)        & $1.298$ & $4.31$ & $1.291$ & $4.26$ \\
M2 (1-mode NLS)              & $2.279$ & $10.7$ & $2.261$ & $10.6$ \\
M3 (ESPRIT $K{=}4$)          & $1.536$ & $7.92$ & $1.552$ & $8.36$ \\
M4 (1-D plateau)             & $\mathbf{0.323}$ & $\mathbf{2.08}$ & $0.246$ & $2.09$ \\
M5 (2-D plateau)             & $0.297$ & $2.38$ & $0.243$ & $2.45$ \\
\bottomrule
\end{tabular}
\end{table}
...
distance for both the hybrid and the fine FD reference alike, so
the degradation is a property of the
...
for the hybrid prediction and the fine FD reference.}
...
$\xq/M$ & $|\Delta\omega|\%$ & $|\Delta\tau|\%$
        & $|\Delta\omega|\%$ & $|\Delta\tau|\%$ \\
\midrule
$2$  & $0.058$ & $0.49$  & $0.014$ & $0.06$  \\
$5$  & $0.113$ & $0.67$  & $0.060$ & $0.46$  \\
$10$ & $0.323$ & $2.08$  & $0.246$ & $2.09$  \\
$15$ & $1.826$ & $5.87$  & $1.720$ & $5.59$  \\
$20$ & $4.915$ & $10.5$  & $4.405$ & $10.7$  \\
\bottomrule
\end{tabular}
\end{table}
