#!/bin/bash
# ============================================================
# SLURM Job: Inverse PINN + QNM (DIAGNOSTIC B, lambda_ring = 100)
# Sole change vs slurm_pinn_inverse_qnm.sh: CONFIG points to the
# lambda_ring = 100 variant. Output directory differs via
# experiment.name so this run cannot overwrite the baseline.
# ============================================================
#SBATCH --job-name=qnm_pinn_iqB
...
CONFIG=configs/zerilli_l2_inverse_qnm_lring100.yaml
...
echo ""
echo "============================================"
echo "[INVERSE+QNM B: lambda_ring=100] Learning M, ω, τ from data"
echo "  Config: $CONFIG"
echo "  lambda_ring = 100.0  (baseline: 1.0)"
echo "============================================"
