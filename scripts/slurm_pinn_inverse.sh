#!/bin/bash
# ============================================================
# SLURM Job: Inverse PINN — Learn M from noisy observations
# ============================================================
#SBATCH --job-name=qnm_pinn_inv
...
CONFIG=configs/zerilli_l2_inverse.yaml
...
echo ""
echo "============================================"
echo "[INVERSE] Learning M from noisy observations"
echo "  Config: $CONFIG"
echo "  M_init = 0.8 (true = 1.0)"
echo "  Noise = 1%"
echo "  Training: 10k Adam + 15k L-BFGS"
echo "============================================"
python scripts/run_pinn_inverse.py --config "$CONFIG"
