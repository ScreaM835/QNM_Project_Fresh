#!/bin/bash
# ============================================================
# SLURM Job: Inverse PINN + QNM (DIAGNOSTIC C, n_ring_points = 1000)
# Sole change vs slurm_pinn_inverse_qnm.sh: CONFIG points to the
# n_ring_points = 1000 variant. Output directory differs via
# experiment.name so this run cannot overwrite the baseline.
# ============================================================
#SBATCH --job-name=qnm_pinn_iqC
...
CONFIG=configs/zerilli_l2_inverse_qnm_nring1000.yaml
...
echo ""
echo "============================================"
echo "[INVERSE+QNM C: n_ring_points=1000] Learning M, ω, τ from data"
echo "  Config: $CONFIG"
echo "  n_ring_points = 1000  (baseline: 200)"
echo "============================================"
