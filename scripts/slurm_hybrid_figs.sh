#!/bin/bash
# ============================================================
# SLURM Job: regenerate the hybrid paper figures for one run.
# Reuses the same environment as slurm_hybrid_eval.sh. Figures are written
# under the run's logging.out_dir/figs, so a new experiment never overwrites
# the figures of another run.
# Usage:
#   sbatch scripts/slurm_hybrid_figs.sh \
